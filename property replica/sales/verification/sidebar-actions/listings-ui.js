...
(function () {
  ...
  function placeControls() {
    ...
    byId(mobile.matches ? 'mobilePrimaryFilters' : 'filterFormHome').appendChild(byId('listingSearchForm'));
  ...
  function openFilters(event) { opener = event.currentTarget; if (!mobile.matches) { openFlyout(dialog,opener); return; } dialog.showModal(); opener.setAttribute('aria-expanded','true'); document.body.style.overflow = 'hidden'; }
